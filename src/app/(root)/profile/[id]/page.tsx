        ...
        <div className="mx-auto space-y-6">
          ...
          <div className="flex flex-col space-y-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex-1 min-w-0">
              <h1 className="text-2xl sm:text-3xl font-bold text-yellow-12 truncate">
                Profile Details
              </h1>
            ...
            <UserProfileActions data={profile} />
          </div>
          ...
          <Card className="bg-white shadow-md">
                ...
                <div>
                  ...
                  <div className="flex items-center mt-1 text-slate-500">
                    ...
                    <span className="capitalize">
                      {profile.user_branch_roles[0].branch_name}
                    </span>
                  </div>
                </div>
              </div>
            ...
            <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-8 p-6">
              ...
              <div className="space-y-6">
                <h3 className="text-lg font-semibold text-yellow-12">
                  Basic Information
                </h3>
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-blue-50 rounded-lg border border-blue-100">
                    <div className="font-medium text-blue-800 capitalize">
                      {profile.user_branch_roles[0].branch_name.replace(
                        /-/g,
                        " "
                      )}
                    </div>
                      ...
                      <div className="ml-6 grid grid-cols-1 gap-2">
                        <div className="text-sm">
                          ...
                          <span className="ml-2 text-slate-700">
                            {profile.details.spouse_name || "Not specified"}
                          </span>
                        </div>
                        <div className="text-sm">
                          <span className="text-slate-500">Phone:</span>
                          <span className="ml-2 text-slate-700">
                            {profile.details.spouse_phone || "Not specified"}
                          </span>
                        </div>
                        <div className="text-sm">
                          <span className="text-slate-500">Occupation:</span>
                          <span className="ml-2 text-slate-700">
                            {profile.details.spouse_occupation ||
                              "Not specified"}
                          </span>
                        </div>
                      </div>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-slate-700">
                          {profile.details.no_of_children || "Not specified"}
                        </span>
                      </div>
                    </div>
                  </div>
                ...
                <div className="space-y-4 bg-white rounded-lg">
                  <div className="grid grid-cols-1 gap-3">
                    <div className="text-sm flex items-center space-x-2">
                      ...
                      <span className="text-slate-700">
                        {profile.details.bank_name || "Not specified"}
                      </span>
                    </div>
                    <div className="text-sm flex items-center space-x-2">
                      ...
                      <span className="text-slate-700">
                        {profile.details.bank_account_name || "Not specified"}
                      </span>
                    </div>
                    <div className="text-sm flex items-center space-x-2">
                      <CreditCardIcon className="w-4 h-4 text-slate-500" />
                      ...
                      <span className="text-slate-700">
                        {profile.details.bank_account_number || "Not specified"}
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1">
                    ...
                    <p className="text-slate-700">
                      {profile.details.personal_email || "Not specified"}
                    </p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-sm text-slate-500">Gender</p>
                    <p className="text-slate-700">
                      {profile.details.gender || "Not specified"}
                    </p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-sm text-slate-500">Date of Birth</p>
                    <p className="text-slate-700">
                      {profile.details.dob || "Not specified"}
                    </p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-sm text-slate-500">IC Number</p>
                    <p className="text-slate-700">
                      {profile.details.ic_number || "Not specified"}
                    </p>
                  </div>
                </div>
              </div>
