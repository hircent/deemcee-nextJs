...
const EditPromoCode = ({ id }: { id: number }) => {
  ...
  const [selectedPromoType, setSelectedPromoType] = useState<
    string | undefined
  >(undefined);
  const [promoCodeData, setPromoCodeData] = useState<PromoCodeData | undefined>(
    undefined
  );
  ...
  const getPromoCode = async () => {
    try {
      ...
      const data = await getPromoCodeDetails(id);
      setPromoCodeData(data);
      setForAllBranches(data.for_all_branches);
      setSelectedPromoType(data.promo_type);
      setSelectedBranch(data.branch?.toString());
      setLoading(false);
    } catch (error) {
      toast({
        title: "Error",
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-4 items-center">
              <Input
                ...
                defaultValue={isForAllBranches ? "true" : "false"}
              />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="123"
                  type="number"
                  defaultValue={promoCodeData?.amount}
                />
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  type="number"
                  placeholder="2000"
                  defaultValue={promoCodeData?.min_purchase_amount}
                />
              ...
              <div className="space-y-2">
                <Input
                  defaultValue={selectedPromoType}
                  type="hidden"
                  name="promo_type"
                  id="promo_type"
                />
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  id="expired_at"
                  name="expired_at"
                  defaultValue={promoCodeData?.expired_at}
                />
                <small className="text-red-500">
