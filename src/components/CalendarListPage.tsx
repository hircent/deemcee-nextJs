...
export function CalendarListTable<TData, TValue>({
  ...
  data,
    ...
    const uniqueYears = Array.from(new Set(data.map((item: any) => String(item.year))));
            ...
            <div className="flex items-center py-4">
                <Select
                    ...
                    <SelectContent className="bg-white flex justify-start">
                        <SelectItem key="all" value="all" className="cursor-pointer hover:bg-yellow-6">
                        <div className="text-left">All</div>
                        </SelectItem>
                        {uniqueYears.map((year) => (
                        <SelectItem key={year} value={year} className="cursor-pointer hover:bg-yellow-6">
