                    ...
                    <div className="space-y-4 py-4">
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                onChange={(e) => setEditedGrade({ ...editedGrade, category: e.target.value })}
                            />
                        </div>
                        <div className="space-y-2">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                onChange={(e) => setEditedGrade({ ...editedGrade, price: Number(e.target.value) })}
                            />
                        </div>
                    </div>
...
const DeleteGrade = ({type,name,gradeId}:{type:string,name:string,gradeId:number}) => {
                    ...
                    <div className="space-y-3">
                        <div className="flex justify-between items-start">
                            ...
                            <div className="flex gap-2">
                                ...
                                <DeleteGrade type="Grade" name={grade.category} gradeId={grade.id}/>
                            </div>
                        </div>
